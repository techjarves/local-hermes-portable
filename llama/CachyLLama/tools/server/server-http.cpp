...
bool server_http_context::init(const common_params & params) {
    ...
    if (!params.ui) {
        ...
        if (!params.public_path.empty()) {
            ...
            // main index file
            srv->Get(params.api_prefix + "/",           serve_asset_cached("index.html", false));
            srv->Get(params.api_prefix + "/index.html", serve_asset_cached("index.html", false));
            ...
            for (const auto & a : llama_ui_get_assets()) {
                ...
                if (no_cache_names.count(a.name)) {
                    ...
                    srv->Get(params.api_prefix + "/" + a.name, serve_asset_cached(a.name, true));
                }
            }
